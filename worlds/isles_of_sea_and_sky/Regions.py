...
isles_of_sea_and_sky_regions = [
    ...
    ("Stoney Cliffs", ["Stoney East Exit", "Stoney West Exit"]),
    ...
    ("Topaz Sea", ["Ancient East Entrance", "Stoney East Entrance", "Diamond Sea West Entrance", "Ruby Sea West Entrance", "Rolling West Entrance", "Rolling East Entrance"]),
    ("Sapphire Sea", ["Stoney West Entrance", "Tidal Entrance", "Sapphire Sea Exit", "Aggro Entrance"]),
...
mandatory_connections = [
    ...
    ("Stoney East Exit", "Topaz Sea"),
    ("Stoney West Exit", "Sapphire Sea"),
    ...
    ("Stoney East Entrance", "Stoney Cliffs"),
    ("Stoney West Entrance", "Stoney Cliffs"),
