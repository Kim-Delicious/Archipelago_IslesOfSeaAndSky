...
advancement_table = {
    "Ancient Rune Tablet":          AdvData(991000,     "Locked"),
    "Topaz Rune Tablet":            AdvData(991001,     "Stoney Cliffs"),
    "Sapphire Rune Tablet":         AdvData(991002,     "Tidal Reef"),
    "Ruby Rune Tablet":             AdvData(991003,     "Raging Volcano"),
    "Diamond Rune Tablet":          AdvData(991004,     "Frozen Spire"),
    "Obsidian Rune Tablet":         AdvData(991005,     "Serpent Stacks"),

    "Topaz Quest Complete":         AdvData(991006,     "Stoney Cliffs"),
    "Sapphire Quest Complete":      AdvData(991007,     "Tidal Reef"),
    "Ruby Quest Complete":          AdvData(991008,     "Raging Volcano"),
    "Diamond Quest Complete":       AdvData(991009,     "Frozen Spire"),

    "Gopher Gloves":                AdvData(991010,     "Stoney Cliffs"),
    "Frog Flippers":                AdvData(991011,     "Tidal Reef"),
    "Salamander Shirt":             AdvData(991012,     "Raging Volcano"),
    "Kite Cape":                    AdvData(991013,     "Frozen Spire"),
    "Serpent Circlet":              AdvData(991014,     "Serpent Stacks"),

    "Topaz Shard Hit":              AdvData(991015,     "Sanctum"),
    "Sapphire Shard Hit":           AdvData(991016,     "Sanctum"),
    "Ruby Shard Hit":               AdvData(991017,     "Sanctum"),
    "Diamond Shard Hit":            AdvData(991018,     "Sanctum"),

    "Blue Stone Tablet":            AdvData(991019,     "Stoney Cliffs"),
    "Gold Stone Tablet":            AdvData(991020,     "Stoney Cliffs"),

    "Fire Key 1":                   AdvData(991021,     "Raging Volcano"),
    "Fire Key 2":                   AdvData(991022,     "Raging Volcano"),
    "Fire Key 3":                   AdvData(991023,     "Raging Volcano"),

    "Egg 1":                        AdvData(991024,     "Frozen Spire"),
    "Egg 2":                        AdvData(991025,     "Frozen Spire"),
    "Egg 3":                        AdvData(991026,     "Frozen Spire"),
    "Wind Key":                     AdvData(991027,     "Frozen Spire"),

    # Order is based on object reference search in UndertaleModTools
    "Ancient Key 1" :               AdvData(991028,     "Ancient Isle"),
    "Ancient Key 2" :               AdvData(991029,     "Ancient Isle"),
    "Ancient Key 3" :               AdvData(991030,     "Ancient Isle"),
    "Ancient Key 4" :               AdvData(991031,     "Ancient Isle"),
    "Ancient Key 5" :               AdvData(991032,     "Ancient Isle"),
    "Ancient Key 6" :               AdvData(991033,     "Ancient Isle"),
    "Ancient Key 7" :               AdvData(991034,     "Ancient Isle"),
    "Ancient Key 8" :               AdvData(991035,     "Ancient Isle"),
    "Ancient Key 9" :               AdvData(991036,     "Ancient Isle"),
    "Ancient Key 10" :              AdvData(991037,     "Ancient Isle"),
    ...
    "Star Piece 1" :                AdvData(991146,     "Ancient Isle"),
    "Star Piece 2" :                AdvData(991147,     "Ancient Isle"),
    "Star Piece 3" :                AdvData(991148,     "Ancient Isle"),
    ...
    "Rolling Bell Rung" :           AdvData(991255,     "Rolling Rocks"),
    "Aggro Bell Rung" :             AdvData(991256,     "Aggro Crag"),
    "Sunken Bell Rung" :            AdvData(991257,     "Sunken Island"),
    "Nanatak Bell Rung" :           AdvData(991258,     "Sea Nanatak"),

    "Phoenix Flute" :               AdvData(991259,     "Beast Bridge"),
    "Star Viewing Orb" :            AdvData(991260,     "Shoal"),
