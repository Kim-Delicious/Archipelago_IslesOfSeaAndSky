...
locksanity_table = {
    ...
    "Topaz Rune Lock [Stone E1]":                   AdvData(61401411, "Stony Cliffs"),
    "Topaz Rune Lock [Stone E2]":                   AdvData(61401421, "Stony Cliffs"),
    "Topaz Rune Lock [Stone E3]":                   AdvData(61401431, "Stony Cliffs"),
    "Topaz Rune Lock [Stone C4]":                   AdvData(61401241, "Stony Cliffs"),
    ...
    "Sapphire Rune Lock [Water D0]":                AdvData(61303301, "Tidal Reef"),
    "Sapphire Rune Lock [Water C3 - E]":            AdvData(61303232, "Tidal Reef"),
    "Sapphire Rune Lock [Water C3 - W]":            AdvData(61303231, "Tidal Reef"),
    "Sapphire Rune Lock [Water B3]":                AdvData(61303131, "Tidal Reef"),

    "Ruby Rune Lock [Fire A1 - S]":                 AdvData(61204011, "Raging Volcano"),
    "Ruby Rune Lock [Fire A1 - E]":                 AdvData(61204012, "Raging Volcano"),
    "Ruby Rune Lock [Fire A2]":                     AdvData(61204021, "Raging Volcano"),
    "Ruby Rune Lock [Fire A3]":                     AdvData(61204031, "Raging Volcano"),
    ...
    "Diamond Rune Lock [Wind E0]":                  AdvData(60805401, "Frozen Spire"),
    "Diamond Rune Lock [Wind D1]":                  AdvData(60805311, "Frozen Spire"),
    "Diamond Rune Lock [Wind C2]":                  AdvData(60805221, "Frozen Spire"),
    "Diamond Rune Lock [Wind C1]":                  AdvData(60805211, "Frozen Spire"),
    "Diamond Rune Lock [Wind B1]":                  AdvData(60805111, "Frozen Spire"),
    "Diamond Rune Lock [Wind B2]":                  AdvData(60805131, "Frozen Spire"),
    "Diamond Rune Lock [Wind A2]":                  AdvData(60805021, "Frozen Spire"),

    "Elemental Rune Lock [Serpent A2]":             AdvData(60906021, "Serpent Stacks"),
    "Obsidian Rune Lock [Serpent A1 - N]":          AdvData(61006011, "Serpent Stacks"),
    "Obsidian Rune Lock [Serpent A1 - W]":          AdvData(61006012, "Serpent Stacks"),
    "Obsidian Rune Lock [Serpent A1 - E]":          AdvData(61006013, "Serpent Stacks"),
    "Obsidian Rune Lock [Serpent A3]":              AdvData(61006031, "Serpent Stacks"),
    ...
    "Ancient Rune Lock [Locked A0]":                AdvData(60712011, "Locked"),
