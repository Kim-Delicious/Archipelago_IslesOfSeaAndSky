...
item_table = {
    ...
    "Serpent Circlet":          ItemData(654,     ItemClassification.progression_skip_balancing),
    "Blue Stone Tablet":        ItemData(596,     ItemClassification.progression_skip_balancing),
    "Gold Stone Tablet":        ItemData(597,     ItemClassification.progression_skip_balancing),
