...
item_table = {
    ...
    "Rolling Bell Rung":        ItemData(901,     IC.progression_skip_balancing),
    "Sunken Bell Rung":         ItemData(902,     IC.progression_skip_balancing),
    "Aggro Bell Rung":          ItemData(903,     IC.progression_skip_balancing),
    "Nunatak Bell Rung":        ItemData(904,     IC.progression_skip_balancing),
