...
item_table = {
    "Ancient Key":              ItemData(109,     IC.progression),
    "Topaz":                    ItemData(784,     IC.progression),
    "Sapphire":                 ItemData(635,     IC.progression),
    "Ruby":                     ItemData(606,     IC.progression),
    "Diamond":                  ItemData(282,     IC.progression),
    "Obsidian":                 ItemData(467,     IC.progression),
    "Star Piece":               ItemData(728,     IC.progression),
    ...
    "Blue Stone Tablet":        ItemData(596,     IC.progression),
    "Gold Stone Tablet":        ItemData(597,     IC.progression),
